...
for (var i = 0; i < names.length; i++) {
  ...
  //  helloSpeaker.speak(names[i]);   correct code if going off of instructions, not example 
  } else {
    helloSpeaker.speak(names[i]);
  //  byeSpeaker.speak(names[i]);     correct code if going of of instructions, not example
  }
}
